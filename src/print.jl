...
print_objective(result::UnsupervisedClusteringResult) = print_objective(result.objective)
...
print_iterations(result::UnsupervisedClusteringResult) = print_iterations(result.iterations)
function print_iterations(iterations::Integer)
    @printf("%8dit ", iterations)
    return nothing
end

print_elapsed(result::UnsupervisedClusteringResult) = print_elapsed(result.elapsed)
...
function print_result(result::UnsupervisedClusteringResult)
